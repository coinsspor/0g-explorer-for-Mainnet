...
contract MyToken {
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      if (chainIdHex !== "0x40f9") {
        try {
          await window.ethereum.request({ 
            method: "wallet_switchEthereumChain", 
            params: [{ chainId: "0x40f9" }] 
          });
...
[rpc_endpoints]
0g_testnet = "https://evmrpc.0g.ai/"`,
      deploy: `forge create --rpc-url https://evmrpc.0g.ai/ \\
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ 
            ...
            Deploy smart contracts to 0G Mainnet with ease. Compile Solidity code and deploy directly from your browser.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                <h3 style={{ color: '#00D4FF', fontSize: '1.1rem', fontWeight: '600', margin: 0 }}>0G Mainnet</h3>
                <p style={{ color: '#9CA3AF', fontSize: '0.9rem', margin: 0 }}>Chain ID: 16661 • RPC: https://evmrpc.0g.ai</p>
              </div>
            </div>
                ...
                {deployedAddress && (
                  <div style={{ marginBottom: '1.5rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      ...
                      <Button
                        onClick={() => window.open(`https://chainscan.0g.ai/address/${deployedAddress}`, '_blank')}
                        variant="ghost"
                        size="sm"
                        style={{ padding: '0.75rem', background: 'rgba(255, 255, 255, 0.1)' }}
                      >
                ...
                {deployHash && (
                  <div style={{ marginBottom: '1.5rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      ...
                      <Button
                        onClick={() => window.open(`https://chainscan.0g.ai/tx/${deployHash}`, '_blank')}
                        variant="ghost"
                        size="sm"
                        style={{ padding: '0.75rem', background: 'rgba(255, 255, 255, 0.1)' }}
                      >
            ...
            <div style={{
              ...
              <div style={{
                ...
                <ol style={{ color: '#9CA3AF', fontSize: '0.95rem', lineHeight: '1.6', paddingLeft: '1.5rem' }}>
                  ...
                  <li>Click "Deploy Contract" to deploy to 0G Mainnet</li>
